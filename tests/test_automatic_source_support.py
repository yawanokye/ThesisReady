    ...
    profile["source_bank"] = [
        {
            ...
            "authors": [f"Researcher{i}, A."],
            "year": "2024",
            "doi": f"10.1234/relevant-{i}",
            "abstract": "Verified abstract evidence directly relevant to exchange-rate pass-through and inflation in Ghana.",
